...
if(WIN32)
  ...
  set(install_cmd copy /Y "${cmake_install_prefix}\\lib\\*.dll" "${cmake_install_prefix}\\bin\\" && xcopy "${cmake_install_prefix}\\lib\\usd" "${cmake_install_prefix}\\bin\\usd" /E/H/C/I && del /Q "${cmake_install_prefix}\\lib\\usd"  )
endif()
