...
if(WIN32)
  ...
  set(install_cmd copy "${cmake_install_prefix}\\lib\\*.dll" "${cmake_install_prefix}\\bin\\" && del "${cmake_install_prefix}\\lib\\*.dll" && xcopy "${cmake_install_prefix}\\lib\\usd" "${cmake_install_prefix}\\bin\\usd" /E/H/C/I && del "${cmake_install_prefix}\\lib\\usd" )
endif()
