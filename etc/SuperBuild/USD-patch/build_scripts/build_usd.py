...
def InstallBoost_Helper(context, force, buildArgs):
    ...
    if context.buildPython and pyVer >= (3, 11):
        BOOST_URL = "https://sourceforge.net/projects/boost/files/boost/1.82.0/source/boost_1_82_0.zip"
    elif context.buildPython and pyVer >= (3, 10):
        BOOST_URL = "https://sourceforge.net/projects/boost/files/boost/1.82.0/source/boost_1_78_0.zip"
