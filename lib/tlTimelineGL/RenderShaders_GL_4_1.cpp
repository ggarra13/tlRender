    ...
    namespace timeline_gl
    {
            ...
            const std::string& toneMap)
        {
            ...
            return string::Format(
                ...
                "{\n"
                "    value[0] = (value[0] - data.minimum[0]) / (data.maximum[0] - data.minimum[0]);\n"
                "    value[1] = (value[1] - data.minimum[1]) / (data.maximum[1] - data.minimum[1]);\n"
                "    value[2] = (value[2] - data.minimum[2]) / (data.maximum[2] - data.minimum[2]);\n"
                "    value[3] = (value[3] - data.minimum[3]) / (data.maximum[3] - data.minimum[3]);\n"
                "    return value;\n"
                "}\n"
                "\n"
                "{1}\n"
                ...
                "    if (normalizeEnabled)\n"
                "    {\n"
                "        outColor = normalizeFunc(outColor, normalizeDisplay);\n"
                "    }\n"
                "    if (invalidValues)\n"
                "    {\n"
