...
namespace tl
{
    namespace device
    {
        ...
        public:
            ...
            virtual std::shared_ptr<observer::IValue<DeviceConfig> > observeConfig() const = 0;
            ...
            virtual std::shared_ptr<observer::IValue<bool> > observeEnabled() const = 0;
            ...
            virtual std::shared_ptr<observer::IValue<bool> > observeActive() const = 0;

            //! Get the output device size.
            virtual const math::Size2i& getSize() const = 0;

            //! Observe the output device size.
            virtual std::shared_ptr<observer::IValue<math::Size2i> > observeSize() const = 0;
            ...
            virtual std::shared_ptr<observer::IValue<otime::RationalTime> > observeFrameRate() const = 0;
            ...
            virtual void setImageOptions(const std::vector<timeline::ImageOptions>&) = 0;

            //! Set the display options.
            virtual void setDisplayOptions(const std::vector<timeline::DisplayOptions>&) = 0;
            ...
            virtual void setBackgroundOptions(const timeline::BackgroundOptions&) = 0;
