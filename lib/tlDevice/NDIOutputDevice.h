...
namespace tl
{
    namespace ndi
    {
        ...
        public:
            ...
            std::shared_ptr<observer::IValue<device::DeviceConfig> > observeConfig() const override;
            ...
            void setImageOptions(const std::vector<timeline::ImageOptions>&) override;

            //! Set the display options.
            void setDisplayOptions(const std::vector<timeline::DisplayOptions>&) override;
            ...
            void setBackgroundOptions(const timeline::BackgroundOptions&) override;
